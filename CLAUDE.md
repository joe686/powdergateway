...
- **项目管理**（v0.1.0 起启用）：`docs/06-项目管理/`
  - [基线目录](docs/06-项目管理/基线/) · [路线图](docs/06-项目管理/路线图.md) · [待办与缺陷池](docs/06-项目管理/待办与缺陷池.md) · [复盘诊断](docs/06-项目管理/复盘诊断/) · [归档](docs/06-项目管理/归档/)
...
## 文档索引同步与归档规约（2026-07-28 v0.2.x 复盘落实）

**触发条件**（下列任一发生时立即同步）：
- 每次 `git tag -a vX.Y.Z` 前
- 每次新增中枢文档（复盘 / GAP 梳理 / 战略参考）
- 每次 CR 落地 CHG 归档
- 每次归档动作后

**必须同步的 3 处顶层索引**：

1. [docs/README.md](docs/README.md) · 顶层索引 · 当前版本 / CHG 数 / 归档区路径
2. [docs/06-项目管理/README.md](docs/06-项目管理/README.md) · 项目管理索引 · 基线列表 / CR 状态 / 归档区
3. [docs/03-开发/任务计划/README.md](docs/03-开发/任务计划/README.md) · 任务计划索引 · 移已完成 · 加新写

**归档动作触发条件与目标位置**：

| 触发 | 归档目标 |
|---|---|
| FB 状态 ✅/🚫/💤 且对应版本已发 | [docs/06-项目管理/归档/反馈簿-历史归档.md](docs/06-项目管理/归档/反馈簿-历史归档.md) |
| CR 落地 CHG · 版本已发 | [docs/06-项目管理/归档/已归档CR.md](docs/06-项目管理/归档/已归档CR.md) |
| 任务计划单元发 tag | [docs/03-开发/任务计划/归档/vX.Y.Z/](docs/03-开发/任务计划/归档/) |
| 反馈图片对应 FB 归档 | [docs/06-项目管理/反馈图片/已完成/](docs/06-项目管理/反馈图片/已完成/) |
| 基线文档发版后 | [docs/06-项目管理/基线/](docs/06-项目管理/基线/) |
| 复盘/GAP 梳理产出后 | [docs/06-项目管理/复盘诊断/](docs/06-项目管理/复盘诊断/) |

**目的**：防止索引与实际状态漂移 · 减少用户认知成本 · 让用户"不看细节也知道去哪找"。项目管理主区（反馈簿 / 待办池 / 路线图）**只装**未做完 / 刚反馈要做 / 需用户确认的活跃条目。
