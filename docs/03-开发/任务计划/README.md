...
| 2026-07-28 | ✅ [归档/v0.3.0/2026-07-28-FB-052-part1-lcpt-host-outbound.md](./归档/v0.3.0/2026-07-28-FB-052-part1-lcpt-host-outbound.md) | **v0.3.0** · SOCK-1~4 · lcpt-host 出站 · 2026-08-02 交付完成(编码 · 待 tag)· CHG-037/038 |
...
**归档规划**（下次 v0.3.1 tag 前统一执行 · v0.1.0/v0.1.1/v0.2.0/v0.2.5 系列一并挪）：
...
- **v0.3.0 已归档**:`归档/v0.3.0/2026-07-28-FB-052-part1-lcpt-host-outbound.md`(2026-08-02 移动)

**待开工的任务计划**(2026-08-02 24 项决策全部拍板 · 无待拍板项):

- ✅ **v0.3.0 SOCK-1~4 已编码完成(2026-08-02)**:[2026-07-28-FB-052-part1-lcpt-host-outbound.md](./2026-07-28-FB-052-part1-lcpt-host-outbound.md) 13 Task 全部落地 · 后端 668 用例全绿 · CHG-037/038 · [v0.3.0-基线.md](../../06-项目管理/基线/v0.3.0-基线.md) · 待用户手工过 MT-20-* + P0 冒烟 + 打 v0.3.0 tag(**前端 wizard 深度集成延到 v0.3.7**)
- 🚧 **v0.3.1 中间收官编码完成 5/7 Task(2026-08-02)**:[2026-08-01-v0.3.1-中间收官.md](./2026-08-01-v0.3.1-中间收官.md) · CR-007 CHG-039 + CR-003 CHG-040 + FB-046 视觉 + FB-054 wizard edit + trace_id CHG-041 已交付 · 后端 699 用例全绿 · 前端 build 通过 · [v0.3.1-基线.md](../../06-项目管理/基线/v0.3.1-基线.md) · **Task 5 v0.2.7 分类型 4 页(6-8 人日)拆下会话 · 归 v0.3.5 或 v0.3.7 独立 minor** · 待手工回归 + 打 v0.3.1 tag
